...
const runSeeds: RunSeed[] = [
  ...
  { run_id: "ir-060", indicator_id: "iv-009", indicator_key: "market_growth_eu", pathway_id: "pw-003", value: 3.2, unit: "%", method_tag: "reported", model: "gemini-2.5-pro", prompt_version: "ind-v1.3", status: "review_pending", triggered_by: "Anže", day: 17, hour: 10, sources: SOURCES.market },
  // iv-008 — no override, two approved runs in history.
  { run_id: "ir-070", indicator_id: "iv-008", indicator_key: "market_size_global", pathway_id: "pw-003", value: 4100, unit: "MEUR", method_tag: "reported", model: "gemini-2.5-flash", prompt_version: "ind-v1.1", status: "approved", triggered_by: "Anže", day: 3, hour: 9, reviewed_by: "Anže", reviewedDay: 3, sources: SOURCES.market },
  { run_id: "ir-071", indicator_id: "iv-008", indicator_key: "market_size_global", pathway_id: "pw-003", value: 4200, unit: "MEUR", method_tag: "reported", model: "gemini-2.5-pro", prompt_version: "ind-v1.2", status: "approved", triggered_by: "Jon Goriup", day: 12, hour: 9, reviewed_by: "Jon Goriup", reviewedDay: 12, sources: SOURCES.market },
