...
const SEEDS: Seed[] = [
  { name: "Bio-based 1,3-Propanediol", materialClass: "Diol", entryType: "Source", category: "Feedstock", ids: "PDO-1042", group: "Personal care", apps: ["Personal care", "Coatings", "Textiles"], volume: 4200, pricePerKg: 2.35, ghgFactor: 1.8, suppliers: 3, status: "in_evaluation", owner: "A. Novak", priority: "H2 2026" },
  { name: "Recycled PET Flake", materialClass: "Polyester", entryType: "Source", category: "Feedstock", ids: "RPET-220", group: "Packaging", apps: ["Packaging", "Textiles"], volume: 18500, pricePerKg: 1.12, ghgFactor: 0.9, suppliers: 7, status: "in_deployment", owner: "M. Fischer" },
  ...
  { name: "Cellulose Nanofibre", materialClass: "Biopolymer", entryType: "Produce", category: "Product", ids: "CNF-014", group: "Composites", apps: ["Composites", "Packaging", "Coatings", "Paper"], volume: 320, pricePerKg: 14.5, ghgFactor: 3.1, suppliers: 1, status: "in_evaluation", owner: "A. Novak" },
  { name: "Sunflower Lecithin", materialClass: "Phospholipid", entryType: "Source", category: "Feedstock", ids: "LEC-556", group: "Food ingredients", apps: ["Food", "Personal care"], volume: 900, pricePerKg: 4.1, ghgFactor: 1.3, suppliers: 4, status: "in_development", owner: "S. Dubois", priority: "H1 2027" },
  ...
  { name: "Chitin from Insect Frass", materialClass: "Biopolymer", entryType: "Valorise", category: "Feedstock", ids: "CHT-902", group: "Agriculture", apps: ["Agriculture", "Personal care"], volume: null, pricePerKg: null, ghgFactor: 2.0, suppliers: 1, status: "in_evaluation", owner: "L. Rossi" },
  { name: "Bio-Naphtha", materialClass: "Hydrocarbon", entryType: "Source", category: "Feedstock", ids: "BNP-118", group: "Polymers", apps: ["Polymers", "Fuels"], volume: 12000, pricePerKg: 1.95, ghgFactor: 0.4, suppliers: 5, status: "adopted", owner: "S. Dubois" },
  ...
  { name: "Isobutanol", materialClass: "Alcohol", entryType: "Produce", category: "Product", ids: "IBA-771", group: "Solvents", apps: ["Solvents", "Coatings", "Fuels"], volume: 3100, pricePerKg: 2.05, ghgFactor: 1.6, suppliers: null, status: "parked", owner: "M. Fischer" },
  { name: "Mycelium Leather Substrate", materialClass: "Biocomposite", entryType: "Produce", category: "Product", ids: "MYC-206", group: "Textiles", apps: ["Textiles", "Automotive"], volume: 45, pricePerKg: null, ghgFactor: null, suppliers: 1, status: "in_evaluation", owner: "S. Dubois", priority: "H2 2026" },
