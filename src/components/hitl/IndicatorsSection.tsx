...
function IndicatorHeader({ showPathway }: { showPathway: boolean }) {
  return <TableHeader><TableRow><TableHead className="w-9" />{showPathway && <TableHead>Pathway</TableHead>}<TableHead>Indicator</TableHead><TableHead>Pipeline value</TableHead><TableHead>Corrected value</TableHead><TableHead>Displayed</TableHead><TableHead>Value date</TableHead><TableHead>Status</TableHead><TableHead>Status changed</TableHead><TableHead>Staleness</TableHead><TableHead>Note</TableHead><TableHead>Trace</TableHead><TableHead className="text-right">Actions</TableHead></TableRow></TableHeader>;
}
