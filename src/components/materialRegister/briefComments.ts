...
const MOCK_COMMENTS: { author: string; days: number; body: string }[][] = [
  [
    ...
    { author: "Ingrid Haugen (Sustainability)", days: 2, body: "Cradle-to-gate figures came back better than the incumbent. I've attached the supplier statement to Sustainability impact." },
  ],
  [
