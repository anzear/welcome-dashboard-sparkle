        ...
        <td className={cellCls}>
          {r.prioritySelected ? (
            <span
              ...
              title={r.priorityPeriod ? `Internal deadline · ${r.priorityPeriod}` : "Internal deadline"}
            >
              <Star className="w-3 h-3 fill-current" />
              {r.priorityPeriod || "Internal deadline"}
            </span>
          ) : (
    ...
    <section className="rounded-lg border-2 border-border bg-card">
      ...
      <div className="px-4 py-3 border-b-2 border-border space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          >
            <SelectTrigger className="h-7 w-auto min-w-[9rem] text-[11px]">
              <SelectValue placeholder="Internal deadline" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value={ALL} className="text-[11px]">Internal deadline: All</SelectItem>
          ...
          <table className="w-full min-w-[1100px]">
            <thead>
              <tr className="bg-muted/30">
                ...
                <th className={cn(headerCls, "text-left")} title="Period the material is prioritised for">Internal deadline</th>
