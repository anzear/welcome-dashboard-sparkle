...
- [ ] Prompt 5: Papers & Patents match review and decisions
- [ ] Prompt 5: Reassignment, mock lookup and linking
- [ ] Prompt 5: Detail sheet with actions and history
- [ ] Prompt 5: Validate live interactions and queue updates
